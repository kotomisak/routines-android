...
//                                Trace.traceEnd(Trace.TRACE_TAG_VIEW);
                    ...
                    }
                    {
                        ...
                        if (view != null) {
                            try {
                                // Delay draw to keep cca 60 FPS
                                long currentNano = System.nanoTime();
                                if(currentNano - mLastDrawNano < mDrawDelayNano) {
                                    Thread.sleep((mDrawDelayNano - (currentNano - mLastDrawNano)) / 1_000_000);
                                }

                                view.mRenderer.onDrawFrame(gl);

                                mLastDrawNano = System.nanoTime();
                            } finally {
                            }
                        }
                    }
        ...
        private long mLastDrawNano = 0;
        private long mDrawDelayNano = (int)((1000 / 60f) * 1000 * 1000);
        /**
