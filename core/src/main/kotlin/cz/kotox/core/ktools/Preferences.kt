...
abstract class SharedPreferencesProvider(open val prefs: SharedPreferences)

@Singleton
class UserSharedPreferencesProvider @Inject constructor(@Named("userPreferences") override val prefs: SharedPreferences):SharedPreferencesProvider(prefs)  {
...
@Singleton
class InstallationSharedPreferencesProvider @Inject constructor(@Named("installPreferences") override val prefs: SharedPreferences):SharedPreferencesProvider(prefs) {
